...
Usage:
	python pika_mq.py c/p  //发送到burp_exchange交换机
	python pika_mq.py c2/p2 //发送到poc_exchange交换机
"""
...
def handle(num,body): 
	print " [x] Consumer_%s Received %r" % (str(num),body)
	#time.sleep(3)
	print " [x] Done"
